  ...
  function item_inicio7($id){
    ...
    $informes = "INFORMES";
      ...
      <div class="uk-card-body uk-padding-remove">
        <a class="a1" href="'.$link.'"> 
          <h3 class="uk-card-title" style="margin-bottom: 0.1em;"><b class="titulo-curso" style="font-family: PoppinsRegular; font-size: .9em;">'.$titulo.'</b></h3>
          <p style="font-family: PoppinsRegular; font-size: .9em;">'.$descripcion.'</p>
      </div></a>
<!-- <div class="botones">
  ...
  function item_inicio8($id){
    ...
    $CONSULTA21 = $CONEXION -> query("SELECT * FROM productos WHERE id = $id");  
		$row_CONSULTA21 = $CONSULTA21 -> fetch_assoc();
    $categoria = $row_CONSULTA21['categoria'];
  ...
  function item_inicio9($id){
    ...
    $widget    = '';
		...
		$CONSULTA11 = $CONEXION -> query("SELECT * FROM productos WHERE id = $id");  
		$row_CONSULTA11 = $CONSULTA11 -> fetch_assoc();
    $titulo = $row_CONSULTA11['titulo'];
    $descripcion = $row_CONSULTA11['txt'];
    $objetivo = $row_CONSULTA11['objetivo'];
