				...
				<div class="uk-width-expand@m uk-visible@m header">
					<div class="uk-text-center container" uk-grid>
						...
						<div class="uk-width-expand@m">
							<div class="uk-flex uk-flex-middle uk-flex-left item uno">
								<a href="tel:+523336413973"><i class="fa fa-phone"></i></a>
								<p class="m-0 uk-flex uk-flex-center">Teléfono</p>
							</div>
							<a href="tel:+523336413973"><p class="uk-padding-remove uk-margin-remove anuncio" style="text-decoration: none; color: black; font-family: PoppinsRegular;">(33) 3641 3973 Ext. 110</p></a>
						</div>
						<div class="uk-width-expand@m ">
							<div class="uk-flex uk-flex-middle  uk-flex-left item dos">
								<a href="mailto:contacto@valegal.mx"><i class="fa fa-envelope"></i></a>
								<p class="m-0 uk-flex uk-flex-left">Email</p>
							</div>
							<a href="mailto:contacto@valegal.mx"><p class="uk-padding-remove uk-margin-remove anuncio" style="text-decoration: none; color: black; font-family: PoppinsRegular;">contacto@valegal.mx</p></a>  
						</div>
						<div class="uk-width-expand@m ">
							...
							<p class="uk-padding-remove uk-margin-remove anuncio" style="font-family: PoppinsRegular;">Lun - Vie de 9:00 a 18:00</p>    
						</div>
								...
								<nav class="uk-navbar-container" uk-navbar>
									<div class="uk-navbar-center">
										...
										<ul class="uk-navbar-nav opt">
											<li><a href="'.$rutaInicio.'" >INICIO</a></li>
											<li><a href="'.$rutaContacto.'" >NOSOTROS</a></li>
											<li><a href="'.$rutaNosotros.'" >ÁREAS DE PRÁCTICA</a></li>
										</ul>
		...
		<div class="bg-footer ">
			<div class="uk-text-center uk-flex uk-flex-middle container" uk-grid>
				...
				<div class="uk-width-expand@m uk-padding-remove">
					<a href="https://goo.gl/maps/CGyNtLxZEfUaXpri9"><div class="uk-flex uk-flex-middle uk-flex-left">
					<p class="info">Información de Contacto</p><img style="width: 5%;margin-bottom: 1em;" src="./img/design/maps.png" alt="">
					</div>
					<p class="direccion">J. Gpe. Montenegro 2116, interior 2, Americana 44160, Guadalajara, Jal. MX.</p></a>
				</div>
				...
				<div class="uk-width-expand@m uk-padding-remove">
					...
					<div class="uk-flex uk-flex-center u-flex-middle" >
					<a href="mailto:contacto@valegal.mx"><i class="fa fa-envelope raya"></i></a>
                        <a href="mailto:contacto@valegal.mx"><p class="m-0 uk-flex uk-flex-left tel">contacto@valegal.mx</p></a>
                    </div>    
				</div>
				<div class="uk-width-auto@m"></div>
				<div class="uk-width-1-1@m uk-margin-remove aviso">
					<p>Copyright 2021 Valegal, Todos los derechos reservados. | Aviso de Privacidad. Desarrollado por <a href="https://galletamkt.com/" style="color: #b27401;; font-weight: bold;">Galleta Marketing Digital</a> </p>
				</div>
			</div>
		</div>
	</footer>
